...
public class ExampleUtils {
  ...
  public void setupBigQueryTable() throws IOException {
    ...
    AggregateTableOptions aggTableOptions =
        options.as(AggregateTableOptions.class);
    if (aggTableOptions.getAggDataset() != null
            && aggTableOptions.getAggTable() != null
            && aggTableOptions.getAggSchema() != null) {
          pendingMessages.add("******************Set Up Big Query Table*******************");
          setupBigQueryTable(aggTableOptions.getProject(),
                            aggTableOptions.getAggDataset(),
                            aggTableOptions.getAggTable(),
                            aggTableOptions.getAggSchema());
          pendingMessages.add("The BigQuery table has been set up for this example: "
              + aggTableOptions.getProject()
              + ":" + aggTableOptions.getAggDataset()
              + "." + aggTableOptions.getAggTable());
        }
